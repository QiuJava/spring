...
//                map.put("mainImgUrl1", item.getMainImgUrl1());
            ...
            String[] cols = new String[]{
                    "orderNo","merchantNo","goodsName","price","num","totalPrice","orderStatusStr",
                    "statusStr","receiver","receiverPhone","receiveAddress","remark",
                    "transStatusStr","transTimeStr","createTimeStr","logisticsTimeStr"
            };
            String[] colsName = new String[]{
                    "订单编号","商户编号","商品标题","商品销售价(元)","购买数量","订单金额(元)","订单状态",
                    "售后状态","收件人","联系方式","收货地址","备注",
                    "支付状态","支付日期","下单日期","发货日期"
            };
