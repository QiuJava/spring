 ...
 * 收款订单查询
 */
angular.module('inspinia', ['infinity.angular-chosen']).controller('receiveOrderCtrl',function($scope,$rootScope,$http,i18nService,$document,SweetAlert,$timeout){
    //数据源
    ...
    $scope.columnDefs = [
        ...
        {field: 'receiveAgentId',displayName: '收款商户ID',width: 140,pinnable: false,sortable: false},
        {field: 'receiveAmount',displayName: '收款金额',width: 140,pinnable: false,sortable: false},
        {field: 'payOrderNo',displayName: '关联订单号',width: 140,pinnable: false,sortable: false},
        {field: 'payMethod',displayName: '支付方式',width: 140,pinnable: false,sortable: false},
        {field: 'transRate',displayName: '商户费率',width: 140,pinnable: false,sortable: false},
...
//        {field: 'totalBonus',displayName: '发放奖金',width: 120,pinnable: false,sortable: false},
        {field: 'createDateStr',displayName: '创建时间',width: 120,pinnable: false,sortable: false},
        ...
        '<a class="lh30" ng-show="grid.appScope.hasPermit(\'superBank.collectOrderDetail\')" '
        + 'ui-sref="superBank.collectOrderDetail({orderNo:row.entity.orderNo})">详情</a>'}
    ];
...
//		rowHeight:35,
    ...
    $scope.exportInfo = function () {
        SweetAlert.swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    location.href="superBank/exportReceiveOrder?baseInfo=" +angular.toJson($scope.baseInfo);
                }
            });
    };
