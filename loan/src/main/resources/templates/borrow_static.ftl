	...
	<div class="navbar navbar-default el-navbar">
		<div class="container">
			...
			<ul class="nav navbar-nav">
				<li id="index"><a href="/website/index">首页</a></li>
				<li id="invest"><a href="/website/invest">我要投资</a></li>
				<li id="borrow"><a href="/website/borrow">我要借款</a></li>
				<li id="account"><a href="#">个人中心</a></li>
				<li><a href="#">新手指引</a></li>
				<li><a href="#">关于我们</a></li>
			</ul>
		</div>
		...
		<div class="row">
			<div class="el-borrow-item col-sm-4">
				...
				<div class="el-borrow-item-content">
					...
					<a href="/website/login" class="el-borrow-apply">
						登陆后申请
					</a>
				</div>
			</div>
	...
	<div class="container-foot-2">
		<div class="context">
			<div class="left">
				<p>个人技术练习</p>
				<p>版权所有：&emsp;绿色版</p>
				<p>地&emsp;&emsp;址：&emsp;深圳市南山区</p>
				<p>电&emsp;&emsp;话： 17728034027&emsp;&emsp;
					邮箱：&emsp;1186335831@qq.com</p>
				<p>
			...
			<div class="right">
				<a target="_blank" href="http://weibo.com/"><img
