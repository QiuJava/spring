	...
	<head>
		...
		$(function(){
			...
			$("#uploadBtn1").uploadify({
				...
				uploader:"/website/realAuth/upload?${_csrf.parameterName}=${_csrf.token}",//后台处理上传文件的地址;
			...
			$("#realAuthForm").ajaxForm(function(data){
				if(data.success){
					$.messager.confirm("提示","实名提交完成",function(){
				...
				<div class="col-sm-9">
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<form class="form-horizontal" id="realAuthForm" method="post" action="/website/realAuth/save" novalidate="novalidate">
						        ...
						        <div class="form-group">
					        		...
					        		<div class="col-sm-8">
					        			...
					        			<div class="idCardItem">
					        				...
					        				<input type="hidden" name="frontImage" id="uploadImage1" />
					        			</div>
					        			<div class="idCardItem">
					        				<div>
					        				...
					        				<input type="hidden" name="reverseImage" id="uploadImage2" />
					        			</div>
