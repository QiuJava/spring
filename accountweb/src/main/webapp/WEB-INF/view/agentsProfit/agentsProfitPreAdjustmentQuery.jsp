...
<body>
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10 location-nav" >
            ...
            <em class=""></em>
            <div class="pull-left active">代理商分润预调账记录查询</div>
        </div>
	</div>
	<!-- 填充内容开始 -->
				...
				<div class="ibox-content">
					 <form class="form-horizontal" id="agentsProfitPreAdjustForm">
                          <div class="form-group" >
                          	  <label class="col-sm-2 control-label">调账日期:</label>
                           		<div class="col-sm-4">
		                            <div class="input-daterange input-group" id="datepicker">
									    <input type="text" class="input-sm form-control" name="adjustTime1" />
									    <span class="input-group-addon">~</span>
									    <input type="text" class="input-sm form-control" name="adjustTime2" />
									</div>   
								</div>
    							...
    							<div class="col-sm-2">
		                            <select class="form-control" name="adjustReason" id="adjustReason"> 
                            ...
                            <div class="form-group" style="margin-bottom:0">
                                   ...
                                   <!-- <div class="col-sm-12 col-sm-offset-13  "> -->
                                   	   <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                                       	...
                                       	<sec:authorize access="hasAuthority('agentsProfitAdjustmentQuery:preAdjustment')">
                                       	<button class="btn btn-success" type="button" id="preAdjustment" style="margin-left:10px;"><span class="glyphicon"></span>预调账</button>
                                       	</sec:authorize>
                                       	<sec:authorize access="hasAuthority('agentsProfitAdjustmentQuery:batchPreAdjustment')">
                                        ...
                                        <sec:authorize access="hasAuthority('agentsProfitAdjustmentQuery:export')">
...
<script src="${ctx}/js/plugins/bootstrap-datepicker/locales/bootstrap-datepicker.zh-CN.min.js"></script>
    ...
    $("#preAdjustment").click(function() {
    	location.href= '${ctx}/agentsProfitAction/agentsProfitPreAdjustment.do';
    });
    $("#bacthPreAdjustment").click(function() {
    	location.href= '${ctx}/agentsProfitAction/agentsProfitBatchPreAdjustment.do';
    });
 // 去除空格啊
	$('input').blur(function() {
		replaceSpace(this);
	...
	/*表单提交时的处理*/
		function exportExcel() {  
			...
			$.download('${ctx}/agentsProfitAction/exportPreAdjustResult.do',data,'post');
	    }
		...
		$(document).ready(function() {
			...
			var data = $("#agentsProfitPreAdjustForm").serialize();
			// 初始化表格
			$("#table_list_agentsProfitPreAdjust")
					.jqGrid(
							{
								url : "${ctx}/agentsProfitAction/findAgentsProfitPreAdjustList.do",
								datatype : "local",
								mtype : "POST",
								height:"auto",
								autowidth: true,
								...
								rowNum: 10,
								rowList: [ 10, 20 ],
								colNames : ['申请调账时间','申请人','代理商编号','代理商名称','开通返现','费率差异','超级推成本','风控扣款','商户管理费','保证金扣除','其他','账户可用余额调账金额','账户冻结余额调账金额','预调账金额','备注'],
								colModel : [
										{name : 'adjustTime',index : 'adjustTime',width : 200,align : "center",formatter : function(val) {return myFormatDate(val,"yyyy-MM-dd hh:mm:ss");}},
										...
										{name : 'openBackAmount',index : 'openBackAmount',width : 150,align : "right",formatter : 'number'},
										{name : 'rateDiffAmount',index : 'rateDiffAmount',width : 150,align : "right",formatter : 'number'},
										{name : 'tuiCostAmount',index : 'tuiCostAmount',width : 150,align : "right",formatter : 'number'},
										{name : 'riskSubAmount',index : 'riskSubAmount',width : 150,align : "right",formatter : 'number'},
										{name : 'merMgAmount',index : 'merMgAmount',width : 150,align : "right",formatter : 'number'},
										{name : 'bailSubAmount',index : 'bailSubAmount',width : 150,align : "right",formatter : 'number'},
										{name : 'otherAmount',index : 'otherAmount',width : 150,align : "right",formatter : 'number'},
