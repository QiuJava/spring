...
<body>
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10 location-nav" >
            ...
            <em class=""></em>
            <div class="pull-left active">出款对账文件下载</div>
        </div>
	</div>
	<!-- 填充内容开始 -->
					 ...
					 <form class="form-horizontal" id="subjectForm">
                          ...
                          <div class="form-group">
                                   ...
                                   <div class="col-sm-2">
										...
										<%--</select>      --%>
										<select class="form-control" name="acqOrg" id="acqOrg">
											<option value="YS_ZQ">YS_ZQ</option>
									   </select>
									</div>
                                  
                                    <label class="col-sm-2 control-label">文件名：</label>
                                   <div class="col-sm-2"><input type="text" class="form-control" name="fileName"></div>									  														  
						</div>
	...
	<script type="text/javascript">
		...
		function Download(id) {   //单击修改链接的操作         
	        ...
	        location.href='${ctx}/chuAccountAction/chuAccountFileDown.do?fileName='+_fileName+'&acqOrg='+_acqOrg;
		...
		$(document).ready(function() {
            ...
            $("#table_list_dui_account").jqGrid({
            	url:"${ctx}/chuAccountAction/findChuAccountFileDownList.do",
                datatype: "json",	
                mtype: "POST",
                height:"auto",
                autowidth: true,
                ...
                colModel: [
                    ...
                    {name: 'size', index: 'size',width: 120, align: "left",sortable:false, formatter:  customBytesToSizeFormatter},
                    {name: 'createDate', index: 'createDate',width: 80, align: "left",sortable:false},
                ...
                gridComplete:function(){  //在此事件中循环为每一行添加修改和删除链接
                    ...
                    for(var i=0; i<ids.length; i++){
                        var id=ids[i];   
                        var detail = "" ;
                        <sec:authorize access="hasAuthority('chuAccountFileDown:download')">
