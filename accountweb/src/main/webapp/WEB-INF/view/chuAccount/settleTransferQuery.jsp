...
<body>
	<div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10 location-nav" >
            ...
            <em class=""></em>
            <div class="pull-left active">结算转账查询</div>
        </div>
	</div>
	<!-- 填充内容开始 -->
	...
	<script type="text/javascript">
		function Detail(id) {   //单击详情链接的操作         
			var model = $("#table_list_bankAccount").jqGrid('getRowData', id);
			var id = model.id;
		...
		$(document).ready(function() {
            ...
            $("#table_list_bankAccount").jqGrid({
            	url:"${ctx}/chuAccountAction/findSettleTransferQueryList.do",
                datatype: "json",	
                mtype: "POST",
                height:"auto",
                autowidth: true,
                ...
                colModel: [
					...
					{name: 'fileName', index: 'fileName', width: 220, align: "center",sortable:false},
					{name: 'operatorName', index: 'operatorName',width: 100, align: "center",sortable:false},
					{name: 'settleBank', index: 'settleBank',width: 150, align: "center",sortable:false},
					{name: 'total', index: 'total',width: 150, align: "center",sortable:false},
					...
					{name: 'summary', index: 'summary',width: 150, align: "center",sortable:false},
                ...
                gridComplete:function(){  //在此事件中循环为每一行添加修改和删除链接
                    ...
                    for(var i=0; i<ids.length; i++){
                        var id=ids[i];   
                        var detail = "<a href='javascript:void(0);' class='default-details'  onclick='Detail(" + id + ")' title='详情'>详情</a>";
