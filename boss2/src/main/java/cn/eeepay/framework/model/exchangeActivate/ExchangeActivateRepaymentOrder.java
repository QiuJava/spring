 ...
 * 对应表 act_repay_order
 */
public class ExchangeActivateRepaymentOrder {
    private Long id;
    ...
    private String reimbursementChann;//还款通道

    private String repayStatus;//还款状态

    private String payType;//还款订单类型

    private BigDecimal planAmount;//目标还款金额

    private BigDecimal actualAmount;//目标还款金额
    ...
    public String getReimbursementChann() {
        return reimbursementChann;
    }

    public void setReimbursementChann(String reimbursementChann) {
        this.reimbursementChann = reimbursementChann;
    }
    ...
    public Date getCompletionTimeBegin() {
        return completionTimeBegin;
    }

    public void setCompletionTimeBegin(Date completionTimeBegin) {
        this.completionTimeBegin = completionTimeBegin;
    }
