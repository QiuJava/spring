...
<#if !userInfo.isWithdraw && bankInfo??>
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<div>
					...
					<#elseif bankInfo??>
					<form id="editForm" class="form-horizontal el-form" action="/withdraw/apply.do" method="post">
						<div class="form-group">
							<label class="control-label col-sm-2">开户行</label>
							<div class="col-sm-10">
								<label class="form-control">
								<script type="text/javascript">
									document.write(SITE_BANK_TYPE_NAME_MAP[${bankInfo.bankName}])
								</script>
								</label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<label class="form-control">${bankInfo.accountNumber}</label>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2">户主姓名</label>
							<div class="col-sm-10">
								<label class="form-control">${bankInfo.accountName}</label>
							</div>
						</div>
						<div class="form-group">
