...
<head>
    ...
    <style>
        .login-bg{background: url("${ctx}/img/login/redem_login_bg.png") no-repeat #DEDFE0; background-size:cover;min-height:600px;}
    </style>
</head>


<body class="loginbg">
<div class="lg-top"><span>欢迎登录积分兑换(激活版)管理系统</span></div>
<div class="row login-bg">
    <div class="loginColumns animated fadeInDown">

        <div class="row loginbox" style="width: 350px;" id="loginDiv">
            <div class="lg-left">
                <h3>登陆</h3>
                ...
                <form action="${loginUrl}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="oemType" name="<%=ClientTeamIdUtil.CLIENT_FIELD_OEM_TYPE%>" value="<%=OemTypeEnum.REDEMACTIVE%>">
                    </div>
...
<%--</div>--%>
<%--<div class="lg-right">--%>
<%--<img src="${ctx}/img/zhf-code.png" alt="中代宝app">--%>
<%--<p>中代宝app下载</p>--%>
<%--</div>--%>
<%--</div>--%>
