			  ...
			  <div class="tab-content">
			    <div role="tabpanel" class="tab-pane active" id="tab2">
			    	<table class="table el-recharge-table">
			    		...
			    		<tbody>
			    			<#list companyBankCards as bankCard>
				    			<tr>
				    				<td>
				    					<div class="bank bank_${bankCard.bankName}"></div>
				    				</td>
			    	...
			    	<div>
			    		...
			    		<form id="rechargeForm" class="form-horizontal el-recharge-form" action="/website/recharge/apply" method="post">
			    			<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
			    			<div class="form-group">
			    				<label class="control-label col-lg-2">银行</label>
			    				<div class="col-sm-10">
			    					<select class="form-control" style="width: 480px;" name="companyBankCard.id">
