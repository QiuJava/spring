...
angular.module('inspinia').controller('rankingPushRecordCtrl',function($scope,$http,i18nService,$document,SweetAlert){
    ...
    $scope.dataTypeList = [{text:"全部",value:""},{text:"收益金额",value:"0"},{text:"会员数",value:"1"},{text:"用户数",value:"2"}];
    ...
    $scope.resetForm = function () {
        $scope.baseInfo = {rankingNo:"",rankingType:"",userCode:"",
            phone:"",accountStatus:"",batchNo:"",dataType:""
        };
    }
    $scope.resetForm();
    ...
    $scope.columnDefs = [
        ...
        {field: 'removeRemark',displayName: '移除说明',width: 150,pinnable: false,sortable: false},
        {field: 'pushTime',displayName: '发放时间',width: 150,pinnable: false,sortable: false,cellFilter:'date:"yyyy-MM-dd HH:mm:ss"'},
        {field: 'removeTime',displayName: '移除时间',width: 150,pinnable: false,sortable: false,cellFilter:'date:"yyyy-MM-dd HH:mm:ss"'},
...
//		rowHeight:35,
    ...
    $scope.query = function () {
        ...
        $scope.loadImg = true;
        $http({
            url: 'superBank/getRankingPushRecord?pageNo='+$scope.paginationOptions.pageNo+'&pageSize='+$scope.paginationOptions.pageSize,
            data: $scope.baseInfo,
            method:'POST'
