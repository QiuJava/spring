...
angular.module('inspinia', ['infinity.angular-chosen']).controller('creditOrderInquiryCtrl',function($scope,$http,i18nService,$document,SweetAlert,$timeout){
    ...
    $scope.resetForm = function () {
        $scope.baseInfo = {productId:"",status:"",orgId:-1,payMethod:"",reportType:"",
            /*completeDateStart:moment(new Date().getTime()-24*60*60*1000).format('YYYY-MM-DD')+' 00:00:00',
    ...
    $scope.resetForm();
    $scope.baseInfo = {
        generationTimeBegin:moment(new Date().getTime()).format('YYYY-MM-DD')+' 00:00:00',
        generationTimeEnd:moment(new Date().getTime()).format('YYYY-MM-DD')+' 23:59:59',
    ...
    setBeginTime=function(setTime){
        $scope.baseInfo.generationTimeBegin = moment(setTime).format("YYYY-MM-DD HH:mm:ss");

    }

    setEndTime=function(setTime){
        $scope.baseInfo.generationTimeEnd = moment(setTime).format("YYYY-MM-DD HH:mm:ss");
    ...
    $scope.columnDefs = [
        ...
        {field: 'orderNo',displayName: '征信订单ID',width: 150,pinnable: false,sortable: false},
        ...
        {field: 'reportType',displayName: '报告类型名称',width: 150,pinnable: false,sortable: false},
        ...
        {field: 'profitDateStr',displayName: '订单分润时间',width: 180,pinnable: false,sortable: false},
        {field: 'createTimeStr',displayName: '订单生成时间',width: 180,pinnable: false,sortable: false},
        {field: 'expiryTimeStr',displayName: '订单失效时间',width: 180,pinnable: false,sortable: false},
        {field: 'refundDateStr',displayName: '退款成功时间',width: 180,pinnable: false,sortable: false},
...
//        {field: 'zxCostPrice',displayName: '征信系统给银行家成本',width: 180,pinnable: false,sortable: false},
//        {field: 'plateProfit',displayName: '平台分润',width: 150,pinnable: false,sortable: false},
        ...
        '<a class="lh30" ng-show="grid.appScope.hasPermit(\'superBank.inquiryOrderDetail\')" '
