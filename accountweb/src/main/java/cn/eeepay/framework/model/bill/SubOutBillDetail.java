...
public class SubOutBillDetail implements Serializable {
	...
	private String isAddBill;// 是否加入出账单 1-已加入，0-未加入
	...
	private String acqMerchantNo;//银联报备商户编号（收单商户编号）
