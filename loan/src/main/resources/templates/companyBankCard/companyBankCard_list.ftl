...
<head>
	...
	$(function(){
		...
		$(".edit_Btn").click(function(){
			...
			$("#editForm input[name=cardNumber]").val(json.cardNumber);
...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-3">
				<#assign currentMenu="companyBank_list">
			...
			<div class="col-sm-9">
				...
				<div class="row">
					<!-- 提交分页的表单 -->
					<form id="searchForm" class="form-inline" method="post" action="/manage/companyBankCard">
				...
				<div class="row">
					<table class="table">
						...
						<tbody>
						<#list pageResult.content as bankCard>
							<tr>
								<td><div class="bank bank_${bankCard.bankName}"></div></td>
								<td>${bankCard.accountName}</td>
								<td>${bankCard.cardNumber}</td>
								<td>${bankCard.bankForkName}</td>
								<td>
									<a href="javascript:void(-1);" class="edit_Btn" data-json='${bankCard.jsonString}'>修改</a> &nbsp;
								</td>
							</tr>
						</#list>
						</tbody>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
			       		<form id="editForm" class="form-horizontal" method="post" action="/manage/companyBankCard/save" style="margin: -3px 118px">
			       			<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
