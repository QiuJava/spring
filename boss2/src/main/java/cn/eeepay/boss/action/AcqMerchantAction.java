...
//	selectByMerNo
    ...
    @ResponseBody
    public Object selectOneAgentNo(@RequestParam("merNo") String merNo) throws Exception {
        Map<String, Object> jsonMap = new HashMap<String, Object>();
        try {
            MerchantInfo mis = merchantInfoService.selectByMerNo(JSON.parse(merNo).toString());
            if (mis == null) {
    ...
    public Object addAcqMerchant(@RequestParam("info") String param) throws Exception {
        ...
        try {
            ...
            if (acqMerchantService.selectInfoByAcqmerNo(acq) != null) {
                ...
                int i = acqMerchantService.insert(acq, str);
                if (i > 0) {
                    jsonMap.put("bols", true);
