 ...
 * oem编辑
 */
angular.module('inspinia').controller('awardParamEditCtrl',function($scope,$http,i18nService,$state,$stateParams){
    ...
    $scope.submitData=function () {
        ...
        $http.post("awardParam/updateAwardParam",
