...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-3">
				<#assign currentMenu="borrowt_publishaudit_list">
		      ...
		      <div class="modal-body">
		      	<form class="form-horizontal" id="editform" method="post" action="/borrow/publish/audit">
					<fieldset>
			        	...
			        	<div class="form-group">
				        	<label class="col-sm-2 control-label" for="borrowtAmount">借款金额(元)</label>
				        	<div class="col-sm-6">
			        	...
			        	<div class="form-group">
				        	<label class="col-sm-2 control-label" for="rate">还款方式</label>
				        	<div class="col-sm-6">
