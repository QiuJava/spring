...
angular.module('inspinia').controller('superPushCashDetailCtrl',function($scope,$http,$stateParams,i18nService){
	...
	//数据源
	$scope.cashDetail = [];
	$http.get('superPushAction/superPushCashDetail?mertId='+$stateParams.mertId)
	...
	$scope.query = function(){
		$http.post('superPushAction/getCashPage',"mertId="+$stateParams.mertId+"&pageNo="+$scope.paginationOptions.pageNo+"&pageSize="+
