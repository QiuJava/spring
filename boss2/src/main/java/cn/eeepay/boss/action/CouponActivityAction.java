...
public class CouponActivityAction {
	...
	public String registerCoupon(Map<String, String> actCouponMap) throws Exception {
		...
		if("3".equals(couponCode)||"6".equals(couponCode)||"8".equals(couponCode)||"9".equals(couponCode)||"15".equals(couponCode)||"16".equals(couponCode)){
		...
		if (activityMap != null && activityMap.size() > 0) {
			...
			if ("3".equals(couponCode)||"6".equals(couponCode)||"8".equals(couponCode)||"9".equals(couponCode)) {
				...
				if("8".equals(couponCode)){
					couponMap.put("coupon_type", activityMap.get("activetiy_code"));
				}
				if("9".equals(couponCode)){
					couponMap.put("coupon_type", activityMap.get("coupon_code"));
				}
...
//			String couponNo = getNext("coupon_no_seq","100000000000");
			...
			if("15".equals(couponCode)){
				couponMap.put("coupon_type",6);
			}
			if("16".equals(couponCode)){
				couponMap.put("coupon_type",3);
			}
