...
public class CjtProfitRuleAction {
    ...
    public Result selectProfitRule(){
        ...
        try {
            ...
            //是否关联鼓励金设置
            CjtProfitRule registerRule = cjtProfitRuleService.selectFirstProfitRuleByType(CjtProfitRule.register);
            //推荐奖励设置
            CjtProfitRule recommondRule = cjtProfitRuleService.selectFirstProfitRuleByType(CjtProfitRule.recommend);
            //活动补贴设置
            CjtProfitRule activityRule = cjtProfitRuleService.selectFirstProfitRuleByType(CjtProfitRule.activity);
