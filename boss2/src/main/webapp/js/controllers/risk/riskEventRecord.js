...
angular.module('inspinia',['uiSwitch']).controller('riskEventRecord',function($scope, $http, $state, $stateParams, i18nService,$filter,SweetAlert,$document) {
	...
	$scope._rulesInstruction=[{text:"全部",value:-1},{text:"商户黑名单",value:1},{text:"身份证黑名单",value:2}
	...
	$scope.info={rulesInstruction:-1,handleStatus:-1,handleResults:-1};
	...
	$scope.reset = function() {
		$scope.info={rollNo:"",merchantNo:"",merchantName:"",agentNo:"",
				rulesInstruction:-1,rulesNo:"",handleStatus:-1,handleResults:-1,handlePerson:"",sCreateTime:"",eCreateTime:"",rollStatus:""}
	};
	...
	$scope.blacklistGrid = {
		    ...
		    columnDefs: [
	                ...
	                {field: 'rulesInstruction',displayName: '规则指令',width: 150,pinnable: false,sortable: false,cellFilter:"rulesInstructionNodes"},
	 ...
	 $scope.exportInfo=function(){
			 SweetAlert.swal({
			        ...
			        function (isConfirm) {
			            if (isConfirm) {
					       	location.href="riskEventRecordAction/eventRecordExport.do?info="+angular.toJson($scope.info);
			            }
		        });
	 }
...
.filter('rulesInstructionNodes', function () {
