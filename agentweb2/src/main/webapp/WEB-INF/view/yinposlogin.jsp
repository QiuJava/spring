...
<body class="loginbg">
<div class="lg-top"><img src="${ctx}/img/login/login_logo@2x.png"><span>欢迎登录银POS管理系统</span></div>
<div class="row login-bg">
    <div class="loginColumns animated fadeInDown">
        ...
        <div class="row loginbox" id="loginDiv">
            <div class="lg-left">
                ...
                <form action="${loginUrl}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="oemType" name="<%=ClientTeamIdUtil.CLIENT_FIELD_OEM_TYPE%>" value="<%=OemTypeEnum.YPOSPAY%>">
                    </div>
            ...
            <div class="lg-right">
                <img src="${ctx}/img/yhb-code.png" alt="银惠宝app">
                <p>银惠宝app下载</p>
            </div>
        </div>
