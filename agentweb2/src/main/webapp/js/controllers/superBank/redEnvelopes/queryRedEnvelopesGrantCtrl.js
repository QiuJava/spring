...
//            { field: 'plateProfit',displayName:'平台分润',width:180,cellFilter:"currency:''" },
            ...
            { field: 'id',displayName:'操作',pinnedRight:true,width:180,
                ...
                '<a ui-sref="red.redEnvelopesGrantDetail({id:row.entity.id})" >详情</a>' +
//                '<a ng-show="row.entity.busType==0&&grid.appScope.hasPermit(\'redEnvelopesGrant.update\')" ui-sref="red.redEnvelopesGrantExamine({id:row.entity.id})" rel="noopener noreferrer" target="_blank" > | 审核</a>' +
