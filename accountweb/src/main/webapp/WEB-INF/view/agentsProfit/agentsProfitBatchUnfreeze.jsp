...
<head>
    ...
    <link href="${ctx}/css/plugins/fileupload/jquery.fileupload.css" rel="stylesheet"/>
...
<body>
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10 location-nav" >
                ...
                <em class=""></em>
                <div class="pull-left active">代理商批量解冻</div>
        </div>
	</div>
	    <!-- 填充内容开始 -->
				...
				<div class="ibox-content">
					 <form class="form-horizontal" id="form1">
                          ...
                          <div class="form-group">
                                   ...
                                   <div class="col-sm-6">
                                        <input type="file" id="fileupload"  name="fileupload"  data-url="${ctx}/agentsProfitAction/batchUnfreezeFileUpload.do" data-badge="false" >
                                    </div>  
						</div>
                             <div class="clearfix lastbottom"></div>
                                   ...
                                   <sec:authorize access="hasAuthority('agentsProfitBatchUnfreeze:downLoad')">
                                   <button class="btn btn-primary btn-xs " type="button" id="btnDownload"><span class="glyphicon glyphicon-send" aria-hidden="true"></span>&nbsp;下载模板</button>
                                    ...
                                    <sec:authorize access="hasAuthority('agentsProfitBatchUnfreeze:upload')"> 
	...
	$('#btnDownload').bind('click', function() {
		 $.download('${ctx}/agentsProfitAction/DownloadBacthUnfreezeTemplate.do','find=commoncode','post');
	});
