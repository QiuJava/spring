...
<head>
	...
	var _teamId = "${teamId}";
	var _entityId = "${entityInfo.entityId}";
	var _entityName = "${agentInfo.agentName}";
	var _userid = "${entityInfo.userId}";
	var _Dlevel = "${agentInfo.agentLevel}";
	var _isAgent = "${isAgent}";
	var _oemType = "${oemType}";
	var _agentType = "${agentInfo.agentType}";
	var _oemTransType = "${oemTransType}";
	var _loginUserType = "${loginUserType}";
	var verNo = "${verNo}";
	var _registType = "${agentInfo.registType}";
	var _hasSafePhone = "${agentInfo.safephone}";
	var _hasSafePassword = "${agentInfo.safePassword}";
	var _safePasswordFlag = "${safePasswordFlag}" === "true";
	</script>
