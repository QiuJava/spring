...
<body>
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10 location-nav" >
                ...
                <em class=""></em>
                <div class="pull-left active">代理商分润预冻结</div>
        </div>
	</div>
	<!-- 填充内容开始 -->
				...
				<div class="ibox-content">
					 <form class="form-horizontal" id="agentsProfitPreFreezeForm">
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-sm-2"><input type="text" class="form-control" name="freezeAmount" id="freezeAmount" required> </div>元		
                            </div>
                            <div class="form-group">		
                                 ...
                                 <div class="form-group">
                                   ...
                                   <!-- <div class="col-sm-12 col-sm-offset-13  "> -->
                                        ...
                                        <sec:authorize access="hasAuthority('agentsProfitPreFreezeQuery:preFreeze')">                               	   
                                       		<button class="btn btn-success" type="submit" id='savePreFreeze'><span class="glyphicon gly-ok"></span>提交</button>
                                       </sec:authorize>
...
<script src="${ctx}/js/plugins/bootstrap-datepicker/locales/bootstrap-datepicker.zh-CN.min.js"></script>
	<script type="text/javascript">
		...
		$("#agentsProfitPreFreezeForm").submit(function(){
			...
			$("#savePreFreeze").attr("disabled","disabled");
            console.log(data);
			$.ajax({
				url:"${ctx}/agentsProfitAction/saveAgentsProfitPreFreeze.do",
				type:"POST",
				data:data,
				success :function(msg){
					if(!msg.status){
			            ...
			            $("#savePreFreeze").removeAttr("disabled"); 
					}else{
						toastr.success(msg.msg,'提示');
						 setTimeout(function() {
			            	location.href='${ctx}/agentsProfitAction/toAgentsProfitPreFreezeQuery.do';
			            }, 1000); 
					}
				}
			});
