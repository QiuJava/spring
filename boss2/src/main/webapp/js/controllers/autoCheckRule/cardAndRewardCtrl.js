 ...
 * 鼓励金详情
 */
angular.module('inspinia').controller('cardAndRewardCtrl',function(SweetAlert,$scope,$http,$stateParams,$state){
	...
	$scope.query = function(){
		...
		$http.get('couponActivity/selectCardAndReward?activetiyCode=12')
		.success(function(msg){
			if(msg.status){
	...
	$scope.commit = function(){
		...
		$http.post('couponActivity/cardAndRewardSave',
