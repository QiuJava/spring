<ul id="menu" class="list-group">
	<li class="list-group-item">
		...
		<ul>
			...
			<li name="borrowBidReturn"><a href="/repaymentSchedule.do"><span>还款明细</span></a></li>
		</ul>
	</li>
	<li class="list-group-item">
		...
		<ul class="in">
			...
			<li name="iplog"><a href="/ipLog/page.do">登录记录</a></li>
			<li name="userInfo"><a href="/userInfo/basic.do"> <span>个人资料</span></a></li>
		</ul>
	</li>
	<li class="list-group-item">
		...
		<ul class="in">
			...
			<li name="recharge"><a href="/recharge/list.do">充值明细</a></li>
			<li name="moneyWithdraw"><a href="/withdraw.do">提现申请</a></li>
		</ul>
	</li>
</ul>
