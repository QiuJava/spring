    ...
    $.extend(F, {
        ...
        defaults: {
            ...
            tpl: {
                ...
                rotateLBtn : '<a title="旋转" class="fancybox-item fancy-rotate" href="javascript:;"></a>',
        ...
        rotateL : function(){
            ...
            console.log(num);
            rad = num*90;
            F.rot(f_w,f_h,translate,rad);
        },
        rot : function(f_w,f_h,translate,rad){
            if(rad/90%2){
        ...
        _afterZoomIn: function () {
            ...
            if (current.rotateLBtn) {
                $(current.tpl.rotateLBtn).appendTo(F.skin).bind('click.fb', function(e) {
                    e.preventDefault();
