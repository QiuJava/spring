...
<div class="row login-bg">
    <div class="loginColumns animated fadeInDown">
        ...
        <div class="row loginbox" id="loginDiv">
            <div class="lg-left">
                ...
                <form action="${loginUrl}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="oemType" name="<%=ClientTeamIdUtil.CLIENT_FIELD_OEM_TYPE%>" value="<%=OemTypeEnum.ZYFPAY%>">
                    </div>
            ...
            <div class="lg-right">
                <img src="${ctx}/img/zyd-code.jpg" alt="自由代app">
                <p>自由代app下载</p>
            </div>
        </div>
