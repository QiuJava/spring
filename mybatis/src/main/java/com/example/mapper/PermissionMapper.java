...
public interface PermissionMapper {
	...
	@Select({ "SELECT ", "	permi_O.id AS id, ", "	permi_O.permission_name AS permission_name, ",
			"	permi_O.authority AS authority, ", "	permi_O.intro AS intro, ", "	permi_O.menu_id AS menu_id  ",
			"FROM ", "	permission permi_O ",
