 ...
 * 办理信用卡订单查询
 */
angular.module('inspinia', ['infinity.angular-chosen']).controller('creditOrderCtrl',function($scope,$rootScope,$http,i18nService,$document,SweetAlert,$timeout){
    //数据源
    i18nService.setCurrentLang('zh-cn');
    $scope.paginationOptions=angular.copy($scope.paginationOptions);
    //订单类型:1代理授权；2信用卡申请 3收款 4信用卡还款
    $scope.statusList = [{text:"全部",value:""},{text:"已创建",value:"1"},{text:"待审核",value:"3"},{text:"已完成",value:"5"},{text:"审核不通过",value:"6"},{text:"已办理过",value:"7"},{text:"回收站",value:"9"}];//订单状态
    ...
    $scope.accountStatus2List = [{text:"全部",value:""},{text:"待入账",value:"0"},{text:"已记账",value:"1"},{text:"记账失败",value:"2"}];//首刷分润记账状态0待入账；1已记账；2记账失败
    $scope.resetForm = function () {
        $scope.selected = "";
        $scope.selected2 = "";
        $scope.selected3 = "";
    	$scope.baseInfo = {orderType:"2",status:"",orgId:-1,oneUserCode:"",bankSourceId:-1,sharePhone:"",
    		accountStatus:"",oneUserType:"",twoUserType:"",thrUserType:"",fouUserType:"",accountStatus2:"",profitStatus2:"",
...
//        {field: 'orgName',displayName: '组织名称',width: 150,pinnable: false,sortable: false},
        {field: 'status',displayName: '订单状态',width: 150,pinnable: false,sortable: false,cellFilter:'formatDropping:[{text:"已创建",value:"已创建"},{text:"待审核",value:"待审核"},{text:"已完成",value:"已完成"},{text:"审核不通过",value:"订单失败"},{text:"已办理过",value:"已办理过"},{text:"回收站",value:"回收站"}]'},
        {field: 'profitStatus2',displayName: '首刷分润状态',width: 150,pinnable: false,sortable: false,cellFilter:"formatDropping:[{text:'已完成',value:'1'},{text:'未完成',value:'0'}]"},
...
//        {field: 'creditcardBankBonus',displayName: '银行发放总奖金',width: 140,pinnable: false,sortable: false},
        {field: 'totalBonus',displayName: '发卡品牌发放总奖金',width: 140,pinnable: false,sortable: false},
        {field: 'totalBonus2',displayName: '首刷品牌发放总奖金',width: 140,pinnable: false,sortable: false},
//        {field: 'totalBonus',displayName: '发放奖金',width: 140,pinnable: false,sortable: false},
        ...
        {field: 'payDate',displayName: '发卡分润时间',width: 120,pinnable: false,sortable: false,cellFilter: 'date:"yyyy-MM-dd HH:mm:ss"'},
        {field: 'payDate2',displayName: '首刷分润时间',width: 120,pinnable: false,sortable: false,cellFilter: 'date:"yyyy-MM-dd HH:mm:ss"'},
        ...
        {field: 'oneUserProfit',displayName: '一级分润发卡',width: 150,pinnable: false,sortable: false},
        {field: 'oneUserProfit2',displayName: '一级分润首刷',width: 150,pinnable: false,sortable: false},
        ...
        {field: 'twoUserProfit',displayName: '二级分润发卡',width: 150,pinnable: false,sortable: false},
        {field: 'twoUserProfit2',displayName: '二级分润首刷',width: 150,pinnable: false,sortable: false},
        ...
        {field: 'thrUserProfit',displayName: '三级分润发卡',width: 150,pinnable: false,sortable: false},
        {field: 'thrUserProfit2',displayName: '三级分润首刷',width: 150,pinnable: false,sortable: false},
        ...
        {field: 'fouUserProfit',displayName: '四级分润发卡',width: 150,pinnable: false,sortable: false},
        {field: 'fouUserProfit2',displayName: '四级分润首刷',width: 150,pinnable: false,sortable: false},
        {field: 'orgName',displayName: '品牌商名称',width: 150,pinnable: false,sortable: false},
        {field: 'orgProfit',displayName: '品牌商分润发卡',width: 150,pinnable: false,sortable: false},
        {field: 'orgProfit2',displayName: '品牌商分润首刷',width: 150,pinnable: false,sortable: false},
//        {field: 'plateProfit',displayName: '品牌代理成本',width: 150,pinnable: false,sortable: false},
        ...
        '<a class="lh30" ng-show="grid.appScope.hasPermit(\'superBank.creditOrderDetail\')" '
        ...
        SweetAlert.swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    ...
                    //    method:"GET"
                    // });
                    location.href="superBank/exportCreditOrder?baseInfo=" +angular.toJson($scope.baseInfo);
                }
            });
    };
