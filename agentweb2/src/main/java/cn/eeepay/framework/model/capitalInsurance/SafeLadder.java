...
public class SafeLadder {
    ...
    private BigDecimal safeInterest;//保额-利息损失赔付
    ...
    public BigDecimal getSafeInterest() {
        return safeInterest;
    }

    public void setSafeInterest(BigDecimal safeInterest) {
        this.safeInterest = safeInterest;
    }
