...
//        recommendedSourceMap.put("3", "超级盟主");
    ...
    public void exportHappyBack(Page<ActivityDetail> page, ActivityDetail ad, HttpServletResponse response) throws IOException {
        ...
        if(list!=null&&list.size()>0){
            ...
            ListDataExcelExport export = new ListDataExcelExport();
            String[] cols = new String[]{"id","activeOrder","activeTime","activityCode","activityTypeName","merchantName",
                    "merchantNo","recommendedSource","repeatRegister","enterTime","acqEnname","transTotal","acqMerchantFee",
            ...
            String[] colsName = new String[]{"序号","激活流水号","激活时间","活动类型","欢乐返子类型","商户名称",
                    "商户编号","推广来源","是否重复注册","进件时间","收单机构","交易金额","上游手续费",
