...
public interface CheckBillDao {
	 ...
	 * @return
	 */
	@Select("select bx_order_no from zjx_trans_order where bx_type in('SUCCESS','OVERLIMIT','RECEDEFAILED') and t_time>=#{startDate} and t_time<=#{endDate}")
	@ResultType(String.class)
	LinkedList<String> getTransOrderSuccess(@Param("startDate")String startDate, @Param("endDate")String endDate);
	 ...
	 * @return
	 */
	@Select("select bx_order_no from zjx_trans_order where bx_type ='OVERLIMIT' and t_time>=#{startDate} and t_time<=#{endDate}")
	@ResultType(String.class)
	LinkedList<String> getTransOrderOver(@Param("startDate")String startDate, @Param("endDate")String endDate);
	/**
	 * 
	 * @param keys
	 * @param orderType 
