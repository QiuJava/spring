...
<body>
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10" >
            ...
            <em class=""></em>
            <div class="pull-left active">确认出账日志查询</div>
        </div>
	</div>
	<!-- 填充内容开始 -->
				...
				<div class="ibox-content">
					 <form class="form-horizontal" id="duiLogForm">
                          <div class="form-group ">
                              ...
                              <div class="col-sm-2"><input type="text" class="form-control" name="outBillId" id="outBillId"></div>
		...
		<div class="col-lg-12">
			<div class="ibox ">
				<div class="ibox-content">
					...
					<table id="table_list_fast_logType"></table>
					<div id="pager_list_fast_logType"></div>
	...
	<script type="text/javascript">
		...
		$("#duiLogForm").submit(function(){
			$("#table_list_fast_logType").setGridParam({
			       datatype : 'json',
		...
		$(document).ready(function() {
            ...
            // 初始化表格
            $("#table_list_fast_logType").jqGrid({
            	url:"${ctx}/optLogsAction/findConfirmAccountOptLogsList.do",
                datatype: "json",	
                mtype: "POST",
                height: 'auto',
                autowidth: true,
                ...
                rowNum: 10,
                rowList: [10, 20],
                colNames:['序号','出账单ID','操作内容','操作人','操作时间'],
                colModel: [
                    {name: 'id', index: 'id', width: 100, align: "center", sortable:false},
                    {name: 'outBillId', index: 'outBillId',width: 200, align: "center", sortable:false},
            ...
            jQuery("#table_list_fast_logType").jqGrid('setFrozenColumns');
            // Add responsive to jqGrid
            $(window).bind('resize', function () {
                var width = $('.jqGrid_wrapper').width();
                $('#table_list_fast_logType').setGridWidth(width);
            });
