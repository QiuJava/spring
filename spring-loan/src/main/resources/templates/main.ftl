...
<html>
	...
	<body>
		...
		<!-- banner广告部分 end -->
		<div style="width: 1100px;margin: 0 auto;height: 60px;border-bottom: 1px solid #969696;border-right: 1px solid #969696;">
			<table id="total_numbers">
				<tr valign="top" align="center" style="margin-top: -5px;">
					<td id="total_bidrequests" width="16.66%" style="color: #09d;font-size: 20px;">借款成功人数:${summaryVO.totalBorrowUser}</td>
					<td id="total_bidrequests" width="16.66%" style="color: #09d;font-size: 20px;">总的借款金额:${summaryVO.totalBorrowAmount}</td>
					<td id="total_bidrequests" width="16.66%" style="color: #09d;font-size: 20px;">为投资人赚取的总利息:${summaryVO.totalInterestAmount}</td>
				</tr>
			</table>
		</div>
		<!-- 项目3大特色feature -->
						...
						<#if borrowList?size &gt; 0 >
							<#list borrowList as data>
								<tr>
									...
									<td class="text-info">${data.amount}</td>
