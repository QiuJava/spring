...
<script type="text/javascript">
	$(function() {
		...
		$(".auditClass").click(function(){
			...
			$("#myModal [name=monthReturn]").html(data.monthReturn);
			$("#myModal [name=totalInterestAmount]").html(data.totalInterestAmount);
		});
...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-3">
				<#assign current="bidrequest_audit1_list"/>
			...
			<div class="col-sm-9">
				...
				<form id="searchForm" class="form-inline" method="post" action="/borrow/audit1.do">
					...
					<table class="table">
						...
						<#list pageResult.content as data>
							<tr>
								...
								<td>${data.amount}</td>
								<td>${data.monthReturn}月</td>
								<td>${data.rate}%</td>
								<td>${data.totalInterestAmount}</td>
								<td>${data.borrowStateDisplay}</td>
								<td>
		  ...
		  <div class="modal-dialog modal-lg" role="document">
		    <div class="modal-content">
		      <div class="modal-body">
		      	<form class="form-horizontal" id="editform" method="post" action="/borrow/audit1/audit.do">
					<fieldset>
						<div id="legend" class="">
							<legend>满标一审</legend>
						</div>
			        	...
			        	<div class="form-group">
				        	<label class="col-sm-2 control-label" for="monthReturn">期限</label>
				        	<div class="col-sm-6">
				        		<label class="form-control" name="monthReturn"></label>
				        	</div>
			        	</div>
			        	<div class="form-group">
			        	...
			        	<div class="form-group">
				        	<label class="col-sm-2 control-label" for="totalInterestAmount">总利息</label>
				        	<div class="col-sm-6">
				        		<label class="form-control" name="totalInterestAmount"></label>
				        	</div>
			        	</div>
						<div class="form-group">
