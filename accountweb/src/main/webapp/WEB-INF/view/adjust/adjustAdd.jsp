                                ...
                                <div class="col-sm-2">
   										<select class="form-control" name="accountType"> 
									         <c:forEach var="adjustAccountType" items="${adjustAccountTypeList}">
												...
												<c:if test="${adjustAccountType.sysValue == 1}">selected="selected"</c:if>>
                            ...
                            <div class="form-group">
                                   ...
                                   <!-- <div class="col-sm-12 col-sm-offset-13"> -->
                                        <%-- <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" /> --%>
                                   		 ...
                                   		 <nobr>
                                   		 <sec:authorize access="hasAuthority('adjustAdd:downloadTpl')">
                                   		 ...
                                   		 <sec:authorize access="hasAuthority('adjustAdd:insert')">
                                   		 	<input id="fileupload" name="fileupload" type="file"  data-url="${ctx}/adjustAction/insertAdjust.do?${_csrf.parameterName}=${_csrf.token}" data-icon="false">
                                   		 </sec:authorize>
                                   		 </nobr>
...
<script src="${ctx}/js/plugins/sweetalert/sweetalert.min.js"></script>
	<script type="text/javascript">
		...
		$('#btnDownload').bind('click', function() {
			 $.download('${ctx}/adjustAction/downloadAdjustAccTemplate.do','find=commoncode','post');
		});
