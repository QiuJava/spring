 ...
 * 产品类别编辑/详情
 */
angular.module('inspinia',['angularFileUpload']).controller('productTypeEditCtrl',function($scope,$http,i18nService,$stateParams,$state,FileUploader){
    ...
    $http.post("productType/getProductType","id="+$stateParams.id,
    ...
    $scope.savetype = function(){
        ...
        $http.post("productType/editProductType",
