 ...
 * 出款明细详情
 */
angular.module('inspinia').controller('hisoutDetailQueryDetailCtrl',function($scope,$http,$state,$stateParams,$compile,$uibModal,$log,i18nService){
	...
	$scope.settleInfo={};
	$http.get('settleOrderInfoHistoryAction/selectOutInfoDetail?ids='+$stateParams.id)
