...
angular.module('inspinia',['uiSwitch']).controller('blacklistQueryCtrl',function($scope, $http, $state,$interval, $stateParams, i18nService,$filter,SweetAlert,$document) {
    ...
    $scope.blacklistGrid = {
        ...
        columnDefs: [
            ...
            {field: 'rollNo',displayName: '商户编号/身份证号/银行卡号',width: 220,pinnable: false,sortable: false},
...
*/
    ...
    $scope.exportInfo=function(){
        SweetAlert.swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    location.href="riskRollAction/exportInfo.do?info="+angular.toJson($scope.info);
                }
            });
    };
