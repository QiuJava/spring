...
<body class="loginbg">
<div class="lg-top"><img src="${ctx}/img/login/login_logo@2x.png"><span>欢迎登录银盛支付机构管理后台</span></div>
<div class="row login-bg">
    <div class="loginColumns animated fadeInDown">

        <div class="row loginbox" id="loginDiv" style="width:350px;">
            <div class="lg-left">
                <h3>登陆</h3>
                ...
                <form action="${loginUrl}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="oemType" name="<%=ClientTeamIdUtil.CLIENT_FIELD_OEM_TYPE%>" value="<%=OemTypeEnum.THREE%>">
                    </div>
                    <div class="form-group forget-ps">
                    </div>
                    <div class="form-group forget-ps">
                     	 <input type="checkbox" class="form-chk"><label>记住账号</label>
                       <%-- <input type="checkbox" class="form-chk" id="teamid2" name="teamid" value="998"><label>超级盟主代理商请勾选</label> --%>
                    ...
                    <c:if test="${param.error != null}">
                        <c:choose>
                            ...
                            <c:when test="${param.error == 'lock'}">
                             ...
                             <c:when test="${param.error == 'forbid'}">
                                <p>当前帐号不存在。</p>
                            </c:when>
...
<div class="loginBottom">
    ...
    <div style="color:#fff; text-align:center; font-size:14px;">
        ...
        <a  target="_blank"  rel="noopener noreferrer" href="http://www.miitbeian.gov.cn">粤ICP备16045637</a>
    </div>
</div>
