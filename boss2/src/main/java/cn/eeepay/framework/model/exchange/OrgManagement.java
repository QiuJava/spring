...
public class OrgManagement {
    ...
    private BigDecimal price;//每1万积分价格

    private Integer lowestExchange;//最低兑换积分
    ...
    public Integer getLowestExchange() {
        return lowestExchange;
    }

    public void setLowestExchange(Integer lowestExchange) {
