...
//	                {text:'5',value:5},{text:'6',value:6},{text:'7',value:7},{text:'8',value:8}];
	...
	$scope.baseInfo = {shareCheck:"",shareLock:"",rateCheck:"",rateLock:"",hasAccount:"",quotaCheck:"",quotaLock:"",agentLevel:-1,teamId:"",hasSub:0,profitSwitch:2,promotionSwitch:2,cashBackSwitch:2};
	...
	$http.get('teamInfo/queryTeamName.do').success(function(msg){
        ...
        $scope.agentGrid.columnDefs.splice($scope.agentGrid.columnDefs.length-2,0,{field: 'teamId',displayName: '所属组织',width:150,cellFilter:"formatDropping:" + $scope.teamTypeStr});
	});
	//查询代理商WEB分润显示开关
