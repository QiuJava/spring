   	...
   	<script type="text/javascript">
            ...
            function replaceSpace(obj){
   			...
   			$("#adjustExamineForm").submit(function(){
				$("#table_list_adjustExamine").trigger("reloadGrid");
				return false;
			});
			...
			function customAccountStatusFmatter(cellvalue, options, rowObject){  
					<c:forEach var="status" items="${adjustAccountStatusList}">
   					...
   					$(document).ready(function() {
			            ...
			            $("#table_list_adjustExamine").jqGrid({
			                ...
			                colModel: [
			                    ...
			                    {name: 'status', index: 'status', width: 90,align:"center", sortable:false,formatter:customAccountStatusFmatter},
			                ],
   					...
   					function Detail(id) {   //单击修改链接的操作         
   						...
   						var id = model.id;
   				        location.href = '${ctx}/business/examineList.do?adjustId='+id;
   					}
