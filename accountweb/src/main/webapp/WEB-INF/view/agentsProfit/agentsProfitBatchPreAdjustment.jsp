...
<body>
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10 location-nav" >
                ...
                <em class=""></em>
                <div class="pull-left active">代理商分润批量预调账</div>
        </div>
	</div>
				...
				<div class="ibox-content">
					 <form class="form-horizontal" id="form1">
                          ...
                          <div class="form-group">
                                   ...
                                   <div class="col-sm-6">
                                        <input type="file" id="fileupload"  name="fileupload"  data-url="${ctx}/agentsProfitAction/batchPreAdjustFileUpload.do" data-badge="false" >
                                    </div>  
						</div>
                             <div class="clearfix lastbottom"></div>
                                   ...
                                   <sec:authorize access="hasAuthority('agentsProfitAdjustmentQuery:downLoad')">
                                   ...
                                   <sec:authorize access="hasAuthority('agentsProfitAdjustmentQuery:upload')"> 
	...
	$('#btnDownload').bind('click', function() {
		 $.download('${ctx}/agentsProfitAction/DownloadBacthAdjustTemplate.do','find=commoncode','post');
	});
