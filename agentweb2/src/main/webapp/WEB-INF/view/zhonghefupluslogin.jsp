...
<body class="loginbg">
<div class="lg-top"><img style="width: 300px;height: 90px;" src="${ctx}/img/login/zf_login_logo.png"><span>欢迎登录超代宝管理系统</span></div>
            ...
            <div class="lg-left">
                ...
                <form action="${loginUrl}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="oemType" name="<%=ClientTeamIdUtil.CLIENT_FIELD_OEM_TYPE%>" value="<%=OemTypeEnum.ZHFPLUSPAY%>">
                    </div>
