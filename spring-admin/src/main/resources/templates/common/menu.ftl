<ul id="menu" class="list-group">
	...
	<li class="list-group-item">
		...
		<ul class="in" id="auditmanage_detail">
			<li class="realAuth"><a href="/realAuth/page.do">实名认证审核</a></li>
			<li class="vedioAuth"><a href="/vedioAuth.do">视频认证审核</a></li>
			<li class="userFileAuth"><a href="/userFile.do">认证材料审核</a></li>
			<li class="bidrequest_publishaudit_list"><a href="/borrow/publish.do">发标前审核</a></li>
			<li class="bidrequest_audit1_list"><a href="/borrow/audit1.do">满标一审</a></li>
