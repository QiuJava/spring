	...
	<body>
		...
		<div class="container">
			<div class="row">
				...
				<!-- 功能页面 -->
				<div class="col-sm-9">
					<form action="/repaymentSchedule" name="searchForm" id="searchForm" class="form-inline" method="post">
						...
						<table class="table">
							...
							<tbody>
								<#list pageResult.content as data>
									<tr>
										<td><a href="/borrow_info?id=${data.borrowId}">${data.borrowTitle}</a></td>
