...
public interface SysDictDao {
	...
	int updateValueBySysKey(@Param("sysValue")String sysValue, @Param("sysKey")String sysKey);
	...
	@Select("select sys_value from sys_dict where sys_key=#{sysKey} and status = '1' limit 1")
