...
public class XssExcelExport extends ExcelExport{
    
    public XssExcelExport() {
        super();
    }
     ...
     * @throws IOException
     */
    public XssExcelExport(String filePath, int sheetNum) throws IOException {
