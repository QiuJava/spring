...
public class StringUtil {
	 ...
	 * @param parm
	 */
	public static String filterNullTwo(Object s) {
		if (s == null) {
			return " ";
		} else {
			return s.toString();
	 ...
	 * @param parm
	 */
	public static String filterZero(Object s) {
		if (s == null) {
			return 0+"";
		} else {
			return s.toString();
	 ...
	 * @param parm
	 */
	public static String serialNo(Object s) {
		if (s == null) {
			return " ";
		} else {
			return s.toString();
...
//	 * @return
//	 */
//	public static List<ShareRule> getShareRule(String sharingRule) {
//		List<ShareRule> shareRuleList = new ArrayList<ShareRule>();
//		if (sharingRule != null && sharingRule.indexOf("|") > -1) {
//			String[] rules = sharingRule.split("\\|");
//			for (String rule : rules) {
//				String[] rl = rule.split("\\~");
//				shareRuleList.add(new ShareRule(Integer.parseInt(rl[0]),
//						Integer.parseInt(rl[2]), Double.parseDouble(rl[1])));
//			}
//		}
...
//	}
	...
	public static int getFourNumber() {
		...
		int number = radom.nextInt(9000) + 1000;
		return number;
	}
