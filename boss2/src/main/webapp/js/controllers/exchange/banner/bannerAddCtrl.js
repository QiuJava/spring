 ...
 * banner新增
 */
angular.module('inspinia',['angularFileUpload']).controller('bannerAddCtrl',function($scope,$http,i18nService,$state,FileUploader){
    ...
    $scope.svaeBanner=function (url) {
        ...
        $http.post("exchangeBanner/addBanner",
