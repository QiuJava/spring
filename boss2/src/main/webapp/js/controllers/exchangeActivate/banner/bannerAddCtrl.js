 ...
 * banner新增
 */
angular.module('inspinia',['angularFileUpload']).controller('exchangeActivateBannerAddCtrl',function($scope,$http,i18nService,$state,FileUploader){
    ...
    $scope.svaeBanner=function (url) {
        ...
        $http.post("exchangeActivateBanner/addBanner",
