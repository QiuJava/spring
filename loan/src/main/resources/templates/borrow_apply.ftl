...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<form class="form-horizontal el-borrow-form" id="editForm" novalidate="novalidate" method="post" action="/website/borrow/apply">
				...
				<div class="form-group">
					...
					<div class="col-sm-3  input-group">
						<input class="form-control" name="borrowAmount" id="borrowAmount"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-3 input-group">
						<select class="form-control" name="repaymentMonths">
				...
				<div class="form-group">
					...
					<label class="radio-inline">
						<input type="radio" value="0" checked="checked" name="repaymentMethod" />
						按月分期
					</label>
					<label class="radio-inline">
						<input type="radio" value="1" name="repaymentMethod" />
						按月到期
					</label>
				</div>
				<div class="form-group">
