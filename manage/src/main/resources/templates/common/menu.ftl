<ul id="menu" class="list-group">
	...
	<li class="list-group-item">
		...
		<ul class="in" id="permissionmanage_detail">
			<li class="systemDictionary"><a href="/systemDictionary/pageQuery"><span>系统数据字典目录</span></a></li>
			<li class="systemDictionaryItem"><a href="/systemDictionaryItem/pageQuery"><span>系统数据字典明细</span></a></li>
