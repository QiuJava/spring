 ...
 * 超级兑用户详情/编辑
 */
angular.module('inspinia').controller('exchangeActivateUserEditCtrl',function($scope,$state,$http,$stateParams,i18nService){
    //数据源
    ...
    $scope.getUserDetail=function(){
        $http.post("exchangeActivateUser/getUserManagementEdit","merchantNo="+$stateParams.merchantNo,
