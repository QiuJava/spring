				...
				<div class="ibox-content">
					 <form class="form-horizontal" id="form1" >
                           <div class="form-group">
                                ...
                                <div class="col-sm-2">
									<label class="control-label">${adjustAccount.id}</label>
                            ...
                            <div class="form-group">
                                   <!-- <div class="col-sm-12 col-sm-offset-13"> -->
                                        ...
                                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                                   		 ...
                                   		 <nobr>
                                   		 <sec:authorize access="hasAuthority('businessRecordListQuery:download')">
                                   		 ...
                                   		 <sec:authorize access="hasAuthority('businessRecordListQuery:update')">
                                   		 	<input id="fileupload" name="fileupload" type="file"  data-url="business/updateBusiness.do?${_csrf.parameterName}=${_csrf.token}" data-icon="false">
                                   		 </sec:authorize>
                                   		 </nobr>
                                   		 </div>
                                   		 <sec:authorize access="hasAuthority('businessRecordListQuery:update')">
...
<script src="${ctx}/js/plugins/sweetalert/sweetalert.min.js"></script>
	...
	$("#btnSubmit").on('click', function () {
		...
		$.ajax({
			url:"${ctx}/business/updateBusinessAccount.do",
			type:"POST",
			data:data,
			success :function(msg){
				if(!msg.statu){
					...
					setTimeout("javascript:location.href='${ctx}/business/businessRecordListQuery.do'", 500);
					//swal({title:"提示" ,text:msg.msg ,animation:"slide-from-top"});
					//alert(msg.msg);	
				}
			}
		...
		$('#btnDownload').bind('click', function() {
			 $.download('${ctx}/business/downloadBusinessAccFile.do?id=${adjustAccount.id}','find=commoncode','post');
		});
