				...
				$(form).ajaxSubmit(function(data){
					if(data.success){
						$.messager.confirm("提示","登陆成功,点击确定跳转到个人中心",function(){
							window.location.href="/website/personalCenter";
						});
					}else{
...
<body>
	...
	<div class="el-header" >
		<div class="container" style="position: relative;">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="/website/register">注册</a></li>
				<li><a href="#">帮助</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="container"  style="min-height: 343px;">  
		<form id="loginForm" class="form-horizontal el-login-form" action="/website/loginUser/login" method="post" >
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" autocomplete="off" name="username" class="form-control" value="qiujian"/>
				</div> 
			</div>
			<div class="form-group">
			...
			<div class="form-gorup">
				<div class="col-sm-offset-3">
					...
					&emsp;&emsp;
					<a href="/website/register">新用户，马上注册</a>
				</div>
			</div>
		</form>
	</div>
