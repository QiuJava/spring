 ...
 * 广告新增
 */
angular.module('inspinia').controller('exchangeActivateHelpCenterAddCtrl',function($scope,$http,i18nService,$state){
    ...
    $scope.addData = function(){
        ...
        $http.post("exchangeActivateHelpCenter/addHelpCenter",
