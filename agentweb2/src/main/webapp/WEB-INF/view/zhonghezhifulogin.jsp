...
<body class="loginbg">
<div class="lg-top"><img style="width: 300px;height: 90px;" src="${ctx}/img/login/zf_login_logo.png"><span>欢迎登录中付支付管理系统</span></div>
        ...
        <div class="row loginbox" id="loginDiv">
            <div class="lg-left">
                ...
                <form action="${loginUrl}" method="post">
                    ...
                    <div class="form-group">
                        <input autocomplete="off" id="password" type="password" class="form-control lg-txt2" placeholder="请输入密码" required="" name="password">
                        <input type="hidden" id="teamid" name="teamid" value="${teamId }">
                        <!-- 100010:直营组织 200010:盛钱包 -->
                        <input type="hidden" id="oemType" name="<%=ClientTeamIdUtil.CLIENT_FIELD_OEM_TYPE%>" value="<%=OemTypeEnum.ZHZFPAY%>">
                    </div>
            ...
            <div class="lg-right">
                <img src="${ctx}/img/zfhhr-code.jpg">
                <p>中付合伙人app下载</p>
            </div>
        </div>
    ...
    <%--<div class="row login-bg">--%>
        <%--<div class="loginColumns animated fadeInDown">--%>
            ...
            <%--<div class="row loginbox"  id="loginDiv">--%>
                ...
                <%--</div>--%>
                <%--<div class="lg-right">--%>
                    <%--<img src="${ctx}/img/zfhhr-code.jpg" alt="返现宝app">--%>
                    <%--<p>中和合伙人app下载</p>--%>
                <%--</div>--%>
            <%--</div>--%>
