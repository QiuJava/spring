		...
		<script type="text/javascript">
			$(function(){
				$("#retroclockbox").flipcountdown({
					size:'xs',
					beforeDateTime:"${borrow.disableDate?datetime}"
				});
			});
		</script>
	</head>
				...
				<div class="col-sm-9">
					<div class="row">
						<div class="col-sm-3">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<p class="text-center">
										<a class="text-info" href="#">${borrow.createUser.username}</a>
									</p><br />
									<div>
									 	籍贯： 广东 - 深圳
									 </div>
							...
							<div>
								<table width="100%" height="250px">
									...
									<tr>
										...
										<td class="text-info" style="padding-left: 10px;">
											${borrow.monthReturn}月
										</td>
										<td class="muted">总可得利息</td>
										<td class="text-info" style="padding-left: 10px;">
											${borrow.totalInterestAmount}
										</td>
									</tr>
									<tr>
										<td class="muted">还款方式</td>
										<td class="text-info" style="padding-left: 10px;">
											${borrow.returnTypeDisplay}
										</td>
						...
						<div class="col-sm-3">
							...
							<#elseif borrow.state==4 || borrow.state==5>
								<h4 class="text-primary">满标审核中</h4>
							<#elseif borrow.state==7>
								<h4 class="text-primary">还款中</h4>
							<#elseif borrow.state==8>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<table class="table table-striped">
								...
								<tbody>
									<#list authHistroyList as authHistroy>
