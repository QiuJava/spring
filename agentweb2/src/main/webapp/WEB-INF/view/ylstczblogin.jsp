...
<body class="loginbg">
<div class="lg-top"><img src="${ctx}/img/login/login_logo@2x.png"><span>欢迎登录移联商通管理系统</span></div>
<div class="row login-bg">
    <div class="loginColumns animated fadeInDown">
        ...
        <div class="row loginbox" id="loginDiv">
            <div class="lg-left">
                ...
                <form action="${loginUrl}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="oemType" name="<%=ClientTeamIdUtil.CLIENT_FIELD_OEM_TYPE%>" value="<%=OemTypeEnum.YLSTCZB%>">
                    </div>
            ...
            <div class="lg-right">
                <img src="${ctx}/img/ylstczb-code.jpg" alt="商通宝app">
                <p>移通宝app下载</p>
            </div>
        </div>
    ...
    <%--<div class="row login-bg">--%>
        <%--<div class="loginColumns animated fadeInDown">--%>
            ...
            <%--<div class="row loginbox" id="loginDiv">--%>
                    ...
                    <%--<c:url value="/perform_login.do" var="loginUrl" />--%>
                        <%--<form action="${loginUrl}" method="post">--%>
                            ...
                            <%--<div class="form-group">--%>
                                ...
                                <%--<input type="hidden" id="teamid" name="teamid" value="${teamId }">--%>
                                <%--<input type="hidden" id="oemType" name="<%=ClientTeamIdUtil.CLIENT_FIELD_OEM_TYPE%>" value="<%=OemTypeEnum.DIANFU%>">--%>
                            <%--</div>--%>
                            <%--<c:if test="${param.logout != null}">--%>
                            <%--<p>您已经退出系统.</p>--%>
                            <%--</c:if>--%>
                ...
                <%--</div>--%>
                <%--<div class="lg-right">--%>
                    <%--<img src="${ctx}/img/dianfu-code.png" alt="点付秘书app">--%>
                    <%--<p>点付秘书app下载</p>--%>
                <%--</div>--%>
            <%--</div>--%>
