...
public class CjtProfitRuleServiceImpl implements CjtProfitRuleService {
    ...
    public List<CjtProfitRule> selectProfitRuleByType(String profitType) {
        List<CjtProfitRule> list =  cjtProfitRuleDao.selectProfitRuleByType(profitType);
    ...
    @Override
    public CjtProfitRule selectFirstProfitRuleByType(String posTrade) {
        return cjtProfitRuleDao.selectFirstProfitRuleByType(posTrade);
    }
