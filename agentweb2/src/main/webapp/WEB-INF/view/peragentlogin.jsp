...
<body class="loginbg">
<div class="lg-top"><img src="${ctx}/img/login_logo@2x.png"><span>欢迎登录超级盟主管理系统</span></div>
<div class="row login-bgperagent">
        ...
        <div class="row loginbox" id="loginDiv">
            <div class="lg-left">
                ...
                <form action="${loginUrl}" method="post">
                    ...
                    <div class="form-group">
                        <input id="password" type="password" autocomplete="off" class="form-control lg-txt2" placeholder="请输入密码" required="" name="password">
<%--                         <input type="hidden" id="teamid" name="teamid" value="${teamId }"> --%>
                        <input type="hidden" id="teamid" name="teamid" value="998">
                        <!-- 100010:直营组织 200010:盛钱包 -->
                        <input type="hidden" id="oemType" name="<%=ClientTeamIdUtil.CLIENT_FIELD_OEM_TYPE%>" value="<%=OemTypeEnum.PERAGENT%>">
                    </div>
                    ...
                    <button id="submit_id" type="submit" class="btn btn-new lg-btn" style="background:#D1AC6D;border-color:#D1AC6D">确定</button>
            ...
            <div class="lg-right">
                <img src="${ctx}/img/1535463791.png">
                <p>超级盟主app下载</p>
            </div>
        </div>

        <jsp:include page="peragentFindPwd.jsp" />
...
<div class="loginBottom">
    ...
    <div style="color:#fff; text-align:center; font-size:14px;">
        ...
        <a rel="noopener noreferrer" target="_blank" href="http://www.miitbeian.gov.cn">粤ICP备16045637</a>
    </div>
</div>
<jsp:include page="peragentFindPwdJS.jsp" />
</body>
                    ...
                    <%--<c:url value="/perform_login.do" var="loginUrl" />--%>
                        <%--<form action="${loginUrl}" method="post">--%>
                            ...
                            <%--<div class="form-group">--%>
                                ...
                                <%--<input type="hidden" id="teamid" name="teamid" value="${teamId }">--%>
                                <%--<input type="hidden" id="oemType" name="<%=ClientTeamIdUtil.CLIENT_FIELD_OEM_TYPE%>" value="<%=OemTypeEnum.SQIANBAO%>">--%>
                                <%--<!-- 100010:直营组织 200010:盛钱包 -->--%>
                            <%--</div>--%>
                            <%--<c:if test="${param.logout != null}">--%>
                            <%--<p>您已经退出系统.</p>--%>
