 ...
 * 产品类别新增
 */
angular.module('inspinia',['angularFileUpload']).controller('productTypeActivateAddCtrl',function($scope,$http,i18nService,$state,FileUploader){
    ...
    //获取默认字段
    $http.post("productTypeActivate/getaddOrgDefault",
    ...
    $scope.savetype = function(){
        ...
        $http.post("productTypeActivate/addProductType",
