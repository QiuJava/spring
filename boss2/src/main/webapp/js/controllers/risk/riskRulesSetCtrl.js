...
//	$scope.nodes=[{text:"交易",value:1},{text:"审件",value:2},{text:"提现",value:3},{text:"实名认证",value:4}];
    ...
    $scope.rulesInstructions=[{text:"全部",value:-1},{text:"商户黑名单",value:1},{text:"身份证黑名单",value:2}
								...
								,{text:"实名认证",value:5},{text:"商户号风险预警",value:6},{text:"银行卡号风险预警",value:7},{text:"商户进件控制",value:8},{text:"商户资料提交控制",value:9}];
	$scope.rulesInstructionModals=[{text:"商户黑名单",value:1},{text:"钱包出账黑名单",value:4},{text:"商户号风险预警",value:6},{text:"银行卡号风险预警",value:7},{text:"商户进件控制",value:8},{text:"商户资料提交控制",value:9}];
