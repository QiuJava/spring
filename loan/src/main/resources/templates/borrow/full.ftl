	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<form id="searchForm" class="form-inline" method="post" action="/manage/borrow/full_audit">
					...
					<table class="table">
						...
						<#list pageResult.content as borrow>
							<tr>
								...
								<td>${(borrow.publishTime?datetime)!'未发布'}</td>
		  ...
		  <div class="modal-dialog modal-lg" role="document">
		    <div class="modal-content">
		      <div class="modal-body">
		      	<form class="form-horizontal" id="editform" method="post" action="/manage/borrow/full_audit">
		      		<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
					<fieldset>
						<div id="legend" class="">
							<legend>满标二审</legend>
