...
public class OutAccountServiceRate implements Serializable {
	/**
	 * 
	 */
    ...
    private String outAccountServiceName;
	...
	public String getOutAccountServiceName() {
		return outAccountServiceName;
	}
	public void setOutAccountServiceName(String outAccountServiceName) {
		this.outAccountServiceName = outAccountServiceName;
	}
