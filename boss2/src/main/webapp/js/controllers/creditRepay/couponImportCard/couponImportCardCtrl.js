 ...
 * 办卡送鼓励金/导入赠送
 */
angular.module('inspinia',['angularFileUpload']).controller('couponImportCardCtrl',function($scope,$http,i18nService,SweetAlert,FileUploader){
    ...
    $scope.addCoupon={sendChannel:"",sendTypeId:"",addNum:null,couponCode:12};
    ...
    var uploader = $scope.uploader = new FileUploader({
        url: 'cardAndReward/couponImportCard',
        queueLimit: 1,   //文件个数
