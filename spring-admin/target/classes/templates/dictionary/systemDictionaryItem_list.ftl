	...
	<script type="text/javascript">
		$(function(){
			...
			$("#addSystemDictionaryItemBtn").click(function(){
				...
				if(pid != -1){
					$("input[name=systemDictionaryId]").val(pid);
			...
			$(".edit_Btn").click(function(){
				...
				$("input[name=systemDictionaryId]").val(json.systemDictionaryId);
				$("#systemDictionaryItemModal").modal("show");
			});
			// 删除一条字典明细
			$(".deleteClass").click(function(){
				...
				$.messager.confirm("确定","确定删除吗",function(){
					window.location.href="/systemDictionaryItem/delete.do?itemId="+id;
				})
			})
		});
		</script>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<div class="col-sm-12">
					<!-- 提交分页的表单 -->
					<form id="searchForm" class="form-inline" method="post" action="/systemDictionaryItem/list.do">
							...
							<ul id="menu" class="list-group">
								<li class="list-group-item">
									...
									<ul class="in" id="systemDictionaryList">
										<#list systemDictionaryList as vo>
								...
								<#list page.content as vo>
									<tr>
										...
										<td>
											...
											<a href="javascript:void(-1);" class="deleteClass" data-id='${vo.id}'>删除</a>
										</td>
									</tr>
								</#list>
								</tbody>
							  ...
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
							      ...
							      <div class="modal-body">
							       	  <form id="editForm" class="form-horizontal" method="post" action="/systemDictionaryItem/update.do" style="margin: -3px 118px">
										    <input type="hidden" name="id" value="" />
									    	<input id="systemDictionaryId" type="hidden" name="systemDictionaryId" value="" />
										   	<div class="form-group">
