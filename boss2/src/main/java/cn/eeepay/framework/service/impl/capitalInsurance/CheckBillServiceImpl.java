...
public class CheckBillServiceImpl implements CheckBillService{
	...
	@Override
	public LinkedList<String>  getTransOrderSuccess(String startDate, String endDate) {
		return checkBillDao.getTransOrderSuccess(startDate,endDate);
	}
	@Override
	public LinkedList<String>  getTransOrderOver(String startDate, String endDate) {
		return checkBillDao.getTransOrderOver(startDate,endDate);
	}
	@Override
