...
public interface AppInfoDao {
	...
	@Insert("Insert into app_info (app_name,app_no,team_id,team_name,code_url,parent_id)"
			+ " values(#{ais.appName},#{ais.appNo},#{ais.teamId},#{ais.teamName},#{ais.codeUrl},#{ais.parentId})")
	...
	@Update("Update app_info set app_name=#{ais.appName},app_no=#{ais.appNo},team_id=#{ais.teamId},team_name=#{ais.teamName},"
			+ "code_url=#{ais.codeUrl},parent_id=#{ais.parentId} where id=#{ais.id}")
	...
	public class SqlProvider{
    	public String selectAllInfo(Map<String,Object> param){
    		...
    		return new SQL(){{
    			SELECT("ais.apply,ais.code_url,ais.id,ais.app_no,ais.app_name as appName,ais.team_name,"
