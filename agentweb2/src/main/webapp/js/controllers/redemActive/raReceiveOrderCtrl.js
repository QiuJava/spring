angular.module('inspinia').controller('raReceiveOrderCtrl',function($scope,$rootScope,$http,$state,$stateParams,$compile,$uibModal,$log,i18nService,SweetAlert){
    ...
    $scope.gridOptions={                           //配置表格
        ...
        columnDefs:[                           //表格数据
            ...
            { field: 'payMethod',displayName:'支付方式',width:150, cellFilter:"formatDropping:" + angular.toJson($scope.payMethodList)},
            { field: 'amount',displayName:'收款金额',width:120},
            { field: 'rate',displayName:'品牌发放总奖金扣率',width:180},
            { field: 'provideAmout',displayName:'品牌发放总奖金',width:120},
    ...
    $scope.query = function () {
        ...
        $http({
            url: 'redemActiveOrderAction/listReceiveOrder?pageNo=' + $scope.paginationOptions.pageNo + "&pageSize=" + $scope.paginationOptions.pageSize,
            data: $scope.info,
            method: 'POST'
