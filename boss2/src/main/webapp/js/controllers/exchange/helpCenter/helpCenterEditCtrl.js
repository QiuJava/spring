 ...
 * 广告新增
 */
angular.module('inspinia').controller('helpCenterEditCtrl',function($scope,$http,i18nService,$state,$stateParams){
    ...
    $http.post("exchangeHelpCenter/getHelpCenter","id="+$stateParams.id,
    ...
    $scope.addData = function(){
        ...
        $http.post("exchangeHelpCenter/updateHelpCenter",
            ...
            .success(function(data){
                ...
                if(data.status){
                    ...
                    $state.transitionTo('exchange.helpCenter',null,{reload:true});
                }else{
                    $scope.notice(data.msg);
                }
            })
