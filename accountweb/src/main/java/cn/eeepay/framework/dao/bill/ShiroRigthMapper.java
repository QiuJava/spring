...
public interface ShiroRigthMapper{
	
	@Insert("insert into shiro_rigth(rigth_code,rigth_name,rigth_comment,rigth_type)"
	...
	@Update("update shiro_rigth set rigth_code=#{shiroRigth.rigthCode},rigth_name=#{shiroRigth.rigthName},rigth_comment=#{shiroRigth.rigthComment},rigth_type=#{shiroRigth.rigthType} where id=#{shiroRigth.id})")
	int updateShiroRigth(@Param("shiroRigth")ShiroRigth shiroRigth);
	
	@Delete("delete from shiro_rigth where rigth_code = #{rigthCode} ")
	int deleteShiroRigthByRigthCode(@Param("rigthCode")String rigthCode);
	
	@Select("select * from shiro_rigth where rigth_code = #{rigthCode}")
	@ResultMap("cn.eeepay.framework.dao.bill.ShiroRigthMapper.BaseResultMap")
	List<ShiroRigth> findShiroRigthByRigthCode(@Param("rigthCode")String rigthCode);
	
	@Select("select id,rigth_code,rigth_name,rigth_comment,rigth_type from shiro_rigth where id =#{id}")
	@ResultMap("cn.eeepay.framework.dao.bill.ShiroRigthMapper.OneToManyResultMap")
	ShiroRigth findShiroRigthById(@Param("id")Integer id);
	
	@Select("select * from shiro_rigth ")
	@ResultMap("cn.eeepay.framework.dao.bill.ShiroRigthMapper.BaseResultMap")
	...
	@ResultMap("cn.eeepay.framework.dao.bill.ShiroRigthMapper.BaseResultMap")
	List<ShiroRigth> findUserRoleRigthByUserId(@Param("userId")Integer userId);
	...
	@Select(" select shiro_rigth.id,shiro_rigth.rigth_code,shiro_rigth.rigth_name,shiro_rigth.rigth_comment,shiro_rigth.rigth_type "+
			"  from role_rigth,shiro_rigth,sys_menu "+
	...
	@Select(" select r.id,r.rigth_code,r.rigth_name,r.rigth_comment,r.rigth_type  "+
			" from sys_menu as m,shiro_rigth as r "+
