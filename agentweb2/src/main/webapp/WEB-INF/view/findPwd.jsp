    ...
    <div class="lg-left">
        ...
        <form action="${ctx}/findPwd.do" method="post">
            ...
            <div class="form-group col-sm-6 col-md-6 col-lg-6">
                <button type="button" id="sendMsgBtn" class="btn btn-new" onclick="sendMsg()">点击获取验证码</button>
            </div>
            <div class="form-group">
                <button type="button" class="btn" style="background: transparent;color: #0d58bd;" onclick="findPwd();">我又想起来了&gt;&gt;</button>
            </div>
            <button id="checkMsgCode" type="button" onclick="checkMsg()" class="btn btn-new lg-btn" disabled>确定</button>
        </form>
    </div>
</div>
    ...
    <form class="form-horizontal" ng-app="myApp" ng-controller="validateCtrl" name="myForm" novalidate>
        ...
        <div class="form-group col-xs-12 col-sm-6 col-md-12 col-lg-12">
            ...
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
                <input type="password" id="newPwd" autocomplete="off" name="newPwd" class="form-control" placeholder="新密码" ng-model="newPwd" ng-pattern="/^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,16}$/" maxlength="16" required>
        ...
        <div class="form-group col-xs-12 col-sm-6 col-md-12 col-lg-12">
            ...
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
                <input type="password"  id="newPwd2" autocomplete="off" name="newPwd2" class="form-control" placeholder="确认密码" ng-model="newPwd2" ng-pattern="/^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,16}$/" maxlength="16" required>
