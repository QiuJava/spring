 ...
 */
@Configuration
public class AuthenticationFailureHandlerWebsite implements AuthenticationFailureHandler {
	...
	public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
		...
		RequestDispatcher dispatcher = request
				.getRequestDispatcher(LoginUserController.WEBSITE_LOGINUSER_LOGINRESULT_MAPPING);
